      ...
      <Container fluid className='main-container'>
        <Row>
          ...
          <Col className='text-container justify-content-center align-items-center left-text'>
            <h1 className='web-text-left'>WEB <br />CHAIN<br />VOTE</h1>
          </Col>
          <Col className='text-container justify-content-center align-items-center right-text'>
            <h3 className='web-text-right'>WEB <br />CHAIN<br />VOTE</h3>
            <h5 className='web-text-right-p'><span>"Your Voice, Your Vote!"</span><br/>Make it count with our secure<br />e-voting platform.</h5>
            <Button variant="dark" type="submit" className='submit-button-admin' href='/voter'>
              Voter Login
            </Button>
            <Button variant="dark" type="submit" className='submit-button-company' href='/company'>
              Company Login
            </Button>
          </Col>
        </Row>
      ...
      <Container fluid className='main-container'>
        <Row>
          ...
          <Col className='text-container justify-content-center align-items-center right-text'>
            ...
            <Button variant="dark" type="submit" className='submit-button-register'>
              Register
            </Button>
            <br />
          </Col>
      ...
      <Container fluid className='main-container-2'>
        <Row xs={1} md={3} className='mt-5 mb-5 g-1'>
          ...
          <Card className='container-uses-vote px-5'>
            <Card.Img className='container-uses-vote-img' variant='top' src={vote} />
              <Card.Body>
                <Card.Title>Cast your vote</Card.Title>
              </Card.Body>
          </Card>
          <Card className='container-uses-result px-4'>
            <Card.Img className='container-uses-result-img' variant='top' src={result} />
              <Card.Body>
